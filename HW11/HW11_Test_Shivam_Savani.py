...
"""
import unittest
from HW11_Shivam_Savani import Student, Instructor, Repository, Major
...
class TestStevensRepo(unittest.TestCase):
    ...
    def test_read_grade(self):
        ...
        path = "C:\Stevens CS\sem3\810 Python prog\Assignments\HW11\HW11test"
    ...
    def test_db_instructor_summary(self):
        ...
        db_path = "C:\Stevens CS\sem3\810 Python prog\Assignments\HW11\stevens.db"
        path = "C:\Stevens CS\sem3\810 Python prog\Assignments\HW11"
        repo = Repository(path)
        pt_expected = repo.instructor_prettytable()
        pt_inst_db = repo.instructor_table_db(db_path)
